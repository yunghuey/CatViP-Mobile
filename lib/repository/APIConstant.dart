class APIConstant {
  // yunghuey
  //static const String ipaddress = "http://10.131.77.249:7015/";
  // wafir
  // static const String ipaddress = "http://10.131.151.180:45455/";
   static const String ipaddress = "http://192.168.0.122:7015/";
  ...
  static String get getSearchUserInfoURL =>
      "${APIConstant.URL}user/GetSearchUserInfo/";
  ...
  static String get GetPostCommentsURL =>
      "${APIConstant.URL}post/getpostcomments/";
  ...
  static String get DeleteActionPostURL =>
      "${APIConstant.URL}post/deleteactpost/";
  ...
  static String get GetApplicationURL =>
      "${APIConstant.URL}Expert/GetLastestApplication";
  static String get RevokeApplicationURL =>
      "${APIConstant.URL}Expert/RevokeApplication/";
  ...
  // report case module
  static String get CreateCaseReportURL =>
      "${APIConstant.URL}caseReport/createCaseReport";
  static String get GetOwnCaseReportURL =>
      "${APIConstant.URL}caseReport/getowncasereports";
  static String get GetCaseReportsURL =>
      "${APIConstant.URL}caseReport/getnearbycasereports";
  static String get CompleteCaseReportsURL =>
      "${APIConstant.URL}caseReport/settlecasereport/";
  static String get RevokeCaseReportsURL =>
      "${APIConstant.URL}caseReport/revokecasereport/";
  static String get CreateCaseReportCommentURL =>
      "${APIConstant.URL}caseReport/createcomment";
  static String get GetCaseReportCommentsURL =>
      "${APIConstant.URL}caseReport/GetCaseReportComments/";
  static String get GetCaseReportsCountURL =>
      "${APIConstant.URL}caseReport/GetNearByCaseReportsCount";
  ...
  static String get UpdateLastSeenURL =>
      "${APIConstant.URL}Chat/UpdateLastSeen/";
  static String get GetCountUnreadURL =>
      "${APIConstant.URL}Chat/GetUnreadChatsCount";
}
